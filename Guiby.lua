...
tpEnemyBtn.Text = "Teleport to Enemy"
tpEnemyBtn.TextColor3 = Color3.fromRGB(240, 240, 245)
...
tpEnemyBtn.MouseButton1Click:Connect(function()
    tweenService:Create(tpEnemyBtn, TweenInfo.new(0.05), {BackgroundColor3 = Color3.fromRGB(50, 50, 55)}):Play()
    pcall(teleportToNearestEnemy)
    task.delay(0.1, function()
        tweenService:Create(tpEnemyBtn, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(35, 35, 40)}):Play()
    end)
end)
